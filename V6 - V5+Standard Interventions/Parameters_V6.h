...
double lambda_s=0.01*P_WearingMasks;
double beta=0.46;
...
double PQ=0.7; //Probability of qurantine if a student start showing symptom/testing positive
int NumTest=3000; //Number of test per day
double TPR=0.97; 
double TNR=0.999;
