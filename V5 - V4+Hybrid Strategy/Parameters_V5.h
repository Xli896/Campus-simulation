...
double Pa=0.7672*ProbCoeff; //Infection probability for a susceptible student given he/she sit next to one asymptomatically infectious student
double Ps=0.95*ProbCoeff;  //Infection probability for a susceptible student given he/she sit next to one symptomatically infectious student
double Pp=0.7672*ProbCoeff; //Infection probability for a susceptible student given he/she sit next to one student in pre-infectious phase
